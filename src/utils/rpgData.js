module.exports = {
    whispering_forest: {
        ...
        monsters: [
            { code: 1001, id: 'slime_leaf', name: '🟢 Slime Lá Mục', level: 1, rarity: 'Common', element: 'Wood', hp: 80, atk: 14, gold: 10, exp: 15, image: 'slime_leaf.png' },
            { code: 1002, id: 'goblin_scout', name: '👺 Yêu Tinh Trinh Sát', level: 5, rarity: 'Common', element: 'Earth', hp: 140, atk: 25, gold: 20, exp: 30, image: 'goblin_scout.png' },
            { code: 1003, id: 'wolf_shadow', name: '🐺 Sói Bóng Đêm', level: 7, rarity: 'Common', element: 'Void', hp: 180, atk: 40, gold: 35, exp: 50, image: 'wolf_shadow.png' },
            { code: 1004, id: 'forest_treant', name: '🌳 Người Cây Già', level: 10, rarity: 'Rare', element: 'Wood', hp: 320, atk: 45, gold: 50, exp: 70, image: 'forest_treant.png' },
            { code: 1005, id: 'giant_spider', name: '🕷️ Nhện Rừng Khổng Lồ', level: 3, rarity: 'Common', element: 'Earth', hp: 120, atk: 35, gold: 35, exp: 55, image: 'giant_spider.png' },
            { code: 1006, id: 'poison_mushroom', name: '🍄 Nấm Độc Lang Thang', level: 2, rarity: 'Common', element: 'Wood', hp: 90, atk: 18, gold: 12, exp: 20, image: 'poison_mushroom.png' },
            { code: 1007, id: 'forest_nymph', name: '🧚 Tiên Rừng Hắc Ám', level: 8, rarity: 'Rare', element: 'Wood', hp: 260, atk: 50, gold: 60, exp: 90, image: 'forest_nymph.png' },
            { code: 1008, id: 'ancient_owlbear', name: '🦉 Gấu Cú Cổ Đại', level: 12, rarity: 'Elite', element: 'Earth', hp: 800, atk: 120, gold: 300, exp: 500, image: 'ancient_owlbear.png' },
            { code: 1009, id: 'forest_bat', name: '🦇 Dơi Rừng Trinh Sát', level: 4, rarity: 'Common', element: 'Wind', hp: 100, atk: 28, gold: 18, exp: 28, image: 'forest_bat.png' },
            { code: 1010, id: 'rogue_ghost_r', name: '👻 Hồn Ma Nhà Thám Hiểm', level: 6, rarity: 'Common', element: 'Void', hp: 160, atk: 45, gold: 35, exp: 45, image: 'rogue_ghost_r.png' },
